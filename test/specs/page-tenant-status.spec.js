describe('page-tenant-status', () => {
  describe('user isn\'t logged as technical user', () => {
    beforeEach(() => {
      ...
      cy.route('GET', 'build/API/system/tenant/*', 'fixture:tenantRunning').as('tenantRunning');
      cy.route('GET', 'build/API/system/session/unusedId', 'fixture:noTechnicalUser').as('noTechnicalUser');

      cy.visit('build/resources/index.html');
    });
  ...
  describe('user is logged as technical user', () => {
    beforeEach(() => {
      ...
      cy.server();
      cy.route('GET', 'build/API/system/session/unusedId', 'fixture:technicalUser').as('technicalUser');
    ...
    it('should display a button to resume tenant when tenant is paused', () => {
      cy.route('GET', 'build/API/system/tenant/*', 'fixture:tenantPaused').as('tenantPaused');
